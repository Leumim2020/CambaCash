...
public:
    ...
    void setupUi(QDialog *editaccount)
    {
        ...
        editaccount->resize(450, 340);
        editaccount->setMinimumSize(QSize(450, 340));
        editaccount->setMaximumSize(QSize(450, 340));
...
"}"));
        ...
        dateEdit->setGeometry(QRect(220, 220, 211, 30));
...
"}"));
        ...
        boxmoney->setGeometry(QRect(220, 90, 211, 30));
...
"}"));
        ...
        label_12->setGeometry(QRect(220, 20, 51, 21));
...
""));
        ...
        label_ID->setGeometry(QRect(280, 20, 151, 21));
...
""));
        ...
        linetotal->setEnabled(false);
        linetotal->setGeometry(QRect(220, 260, 211, 30));
...
""));
        ...
        label_9->setGeometry(QRect(10, 90, 151, 31));
        QFont font1;
...
""));
        ...
        label_10->setGeometry(QRect(10, 170, 191, 31));
...
""));
        ...
        label_11->setGeometry(QRect(10, 260, 131, 31));
...
""));
        ...
        pushButton->setGeometry(QRect(220, 300, 211, 30));
...
"}"));
        ...
        linearea->setGeometry(QRect(220, 50, 211, 30));
...
"}"));
        ...
        linehour->setGeometry(QRect(220, 130, 160, 30));
...
"}"));
        ...
        labelperiodo->setGeometry(QRect(390, 130, 41, 30));
...
"}\n"
""));
        lineEditdate = new QLineEdit(editaccount);
        lineEditdate->setObjectName("lineEditdate");
        lineEditdate->setEnabled(false);
        lineEditdate->setGeometry(QRect(220, 170, 211, 31));
        lineEditdate->setStyleSheet(QString::fromUtf8("QLineEdit{\n"
"	background-color: white;\n"
"	border:1px solid rgb(59,81,127);\n"
"	color: rgb(59,81,127);\n"
"}"));
        lineEditdate->setMaxLength(37);
        label_13 = new QLabel(editaccount);
        label_13->setObjectName("label_13");
        label_13->setGeometry(QRect(10, 220, 191, 31));
...
""));
    ...
    void retranslateUi(QDialog *editaccount)
    {
        ...
        linetotal->setInputMask(QString());
        ...
        label_10->setText(QCoreApplication::translate("editaccount", "DATA PREVIOUS (DD/MM/YYYY) ", nullptr));
        ...
        label_13->setText(QCoreApplication::translate("editaccount", "DATA CURRENT (DD/MM/YYYY) ", nullptr));
    } // retranslateUi
