...
"color: rgb(255, 212, 38);"));
        ...
        label_db->setObjectName("label_db");
        label_db->setGeometry(QRect(15, 290, 16, 21));
        label_db->setStyleSheet(QString::fromUtf8("color: rgb(255, 212, 38);"));
    ...
    void retranslateUi(QMainWindow *login)
    {
        ...
        label_db->setText(QCoreApplication::translate("login", "-1", nullptr));
    } // retranslateUi
